  ...
  return (
    <div className="grid grid-cols-2 gap-[34px]">
      <div className="shadow-[0px_4px_4px_0px_#00000040]  rounded-[2px] px-[12px] pt-[8px] pb-[37px] border border-[1px] border-[#00000033]">
        <div className="flex justify-between items-center">
          ...
          <div className="grid grid-cols-3 gap-[5px]">
            <div className="py-[4px] h-[20px] w-[80px] shadow-[0px_2px_2.08px_0px_#00000040] flex justify-center items-center rounded-[4px]">
              <p className="font-poppins font-[8px] text-[#000000]">Days</p>
            </div>
      ...
      <div className="shadow-[0px_4px_4px_0px_#00000040]  rounded-[2px] px-[12px] pt-[8px] pb-[37px] border border-[1px] border-[#00000033]">
        ...
        <div className="mt-[9px] bg-[#F7F7F7] rounded-[2px] flex justify-center items-center shadow-[0px_4px_4px_0px_#00000040] ">
          <div className=" py-[25px] flex flex-row gap-[10px] items-center">
            <PieChartComponent
              colors={["#1D345C", "#9C6DDF"]}
              labels={["65 %", "35 %"]}
              descriptions={["Plan Distribution:", "Revenue Contribution"]}
              data={[
                {
                  name: "Medium",
                  value: 55,
